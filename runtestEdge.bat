...
echo %isodate%
call npx playwright test generate.main.spec.ts --project=MSEdge
call npx playwright test main.runeachtest.spec.ts --project=MSEdge --headed --reporter=line,allure-playwright
