...
echo %isodate%
call npx playwright test generate.main.spec.ts --project=chromium
call npx playwright test main.runeachtest.spec.ts --project=chromium --headed --reporter=line,allure-playwright
